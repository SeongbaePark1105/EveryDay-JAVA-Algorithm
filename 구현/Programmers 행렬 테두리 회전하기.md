...
> 구현 문제 입니다.
>
>  배열 기준 왼쪽 y축, 아래쪽 x축, 오른쪽y축, 위쪽x축 순으로 회전시켜서 풀었습니다.
>
> `temp`변수에 미리 시작 값을 저장시키고 `min`변수에도 저장을 해줍니다.
>
> 이제 반복문을 이용하여 값들을 덮어씌워주고 회전 하면서 만나는 값들을 `Math.min`을 사용하여 최소값을 비교해줍니다.
